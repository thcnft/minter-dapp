...
const welcome_h1 = "Welcome to the Treasurehuntingclub NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Treasurehuntingclub NFT Project is a The first NFT collection, by collecting which you can become the owner of huge treasures :)';
